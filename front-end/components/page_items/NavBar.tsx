...
function NavBar({ className }: Props) {
  ...
  return (
    <div className="relative w-full bg-white">
      <div className="mx-auto flex  items-center justify-between px-6 py-2 sm:px-10 lg:px-16">
          ...
          <ul className="inline-flex space-x-8">
            {menuItems.map((item) => (
              <li key={item.name}>
                <a
                  href={item.href}
                  className="inline-flex items-center text-sm font-semibold text-gray-600 transition duration-300 hover:text-gray-900"
                >
                  {item.name}
                  <span>
        ...
        <div className="hidden space-x-2 lg:block text-slate-600 ">
          <button
            type="button"
